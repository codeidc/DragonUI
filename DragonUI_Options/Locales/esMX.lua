...
L["Group Headline Mode"] = "Modo solo nombre (grupo)"
L["Headline Mode (Party/Raid)"] = "Modo solo nombre (grupo/banda)"
L["Hide health, power and cast bars on party and raid member nameplates, showing only the name."] = "Oculta las barras de vida, energía y lanzamiento en las placas de miembros de grupo y banda, mostrando solo el nombre."
L["Class Color Names"] = "Nombres con color de clase"
L["Color party and raid member names by class while in headline mode."] = "Colorea los nombres de los miembros de grupo y banda según su clase en el modo solo nombre."
