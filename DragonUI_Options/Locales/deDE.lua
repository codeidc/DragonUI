...
L["Group Headline Mode"] = "Gruppen-Namensmodus"
L["Headline Mode (Party/Raid)"] = "Namensmodus (Gruppe/Schlachtzug)"
L["Hide health, power and cast bars on party and raid member nameplates, showing only the name."] = "Lebens-, Energie- und Zauberleisten bei Namensplaketten von Gruppen- und Schlachtzugsmitgliedern ausblenden und nur den Namen anzeigen."
L["Class Color Names"] = "Namen in Klassenfarben"
L["Color party and raid member names by class while in headline mode."] = "Namen von Gruppen- und Schlachtzugsmitgliedern im Namensmodus nach Klasse einfärben."
