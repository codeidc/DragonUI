...
L["Group Headline Mode"] = "Режим только имени (группа)"
L["Headline Mode (Party/Raid)"] = "Режим только имени (группа/рейд)"
L["Hide health, power and cast bars on party and raid member nameplates, showing only the name."] = "Скрывает полосы здоровья, ресурса и заклинаний на индикаторах членов группы и рейда, показывая только имя."
L["Class Color Names"] = "Имена цветами классов"
L["Color party and raid member names by class while in headline mode."] = "Окрашивать имена членов группы и рейда по классу в режиме только имени."
