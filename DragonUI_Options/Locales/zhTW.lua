...
L["Group Headline Mode"] = "隊伍僅名稱模式"
L["Headline Mode (Party/Raid)"] = "僅名稱模式（小隊/團隊）"
L["Hide health, power and cast bars on party and raid member nameplates, showing only the name."] = "隱藏小隊和團隊成員名牌上的生命、能量和施法條，僅顯示名稱。"
L["Class Color Names"] = "名稱職業顏色"
L["Color party and raid member names by class while in headline mode."] = "在僅名稱模式下，依職業為小隊和團隊成員的名稱著色。"
