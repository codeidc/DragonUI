...
L["Group Headline Mode"] = "队伍仅名称模式"
L["Headline Mode (Party/Raid)"] = "仅名称模式（小队/团队）"
L["Hide health, power and cast bars on party and raid member nameplates, showing only the name."] = "隐藏小队和团队成员姓名板上的生命、能量和施法条，仅显示名称。"
L["Class Color Names"] = "名称职业颜色"
L["Color party and raid member names by class while in headline mode."] = "在仅名称模式下，按职业为小队和团队成员的名称着色。"
