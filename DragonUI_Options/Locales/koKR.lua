...
L["Group Headline Mode"] = "그룹 이름 전용 모드"
L["Headline Mode (Party/Raid)"] = "이름 전용 모드 (파티/공격대)"
L["Hide health, power and cast bars on party and raid member nameplates, showing only the name."] = "파티 및 공격대원 이름표에서 생명력, 자원, 시전 막대를 숨기고 이름만 표시합니다."
L["Class Color Names"] = "이름 직업 색상"
L["Color party and raid member names by class while in headline mode."] = "이름 전용 모드에서 파티 및 공격대원 이름을 직업 색상으로 표시합니다."
